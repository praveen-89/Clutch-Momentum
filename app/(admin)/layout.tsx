...
import { ShieldCheck, Search, Bell, Monitor } from "lucide-react";
    ...
    return (
      <div className="h-screen w-full flex items-center justify-center bg-slate-950">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 border-4 border-orange-500/20 border-t-orange-500 rounded-full animate-spin shadow-[0_0_20px_rgba(249,115,22,0.3)]" />
          <p className="text-[10px] uppercase font-black tracking-[0.4em] text-slate-500 animate-pulse">
        ...
        <header className="h-20 border-b border-slate-200 px-10 flex items-center justify-between bg-white/40 backdrop-blur-2xl z-20 sticky top-0">
          <div className="flex items-center gap-8">
            <div className="space-y-1">
                ...
                Operational Status: <span className="text-orange-600">Active Node</span>
                </h2>
            ...
            <div className="flex items-center gap-2 group cursor-pointer">
               ...
               <span className="text-[11px] font-black uppercase tracking-widest text-orange-600">Root Access Granted</span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                    <div className="text-right hidden sm:block">
                        ...
                        <p className="text-[9px] text-orange-600/60 uppercase font-black mt-1.5 tracking-widest">Master Admin</p>
                    </div>
